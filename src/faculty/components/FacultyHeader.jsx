        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/faculty/events" className="text-xl font-bold text-gray-900">
              EventHub
              <span className="text-blue-600"> Faculty</span>
            </Link>
          </div>
            ...
            {localStorage.getItem("facultyData") && (
              <div className="flex items-center gap-3">
                <Link
                  ...
                  title="userprofile"
                >
                  <div className="w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center font-bold border border-blue-200">
