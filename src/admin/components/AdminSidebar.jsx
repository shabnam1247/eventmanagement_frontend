...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 h-screen z-40 bg-white border-r border-gray-200 transition-all duration-300 ease-in-out
          ...
          <div className="flex items-center gap-3">
            ...
            {!isCollapsed && (
              <div className="font-bold text-xl tracking-tight">
                ...
                <span className="block text-[10px] text-gray-400 -mt-1 uppercase tracking-widest">Admin Panel</span>
              </div>
            )}
          </div>
        </div>
