              ...
              >
                <div className="p-8 flex-1">
                  ...
                  <div className="mb-6">
                    ...
                    <h3 className="text-sm font-bold text-gray-900 line-clamp-1">{feedback.eventTitle || "General Feedback"}</h3>
                  </div>
                  
                  <blockquote className="text-gray-700 leading-relaxed font-medium italic mb-2 relative">
                    <span className="text-2xl text-blue-100 absolute -top-3 -left-3">"</span>
                    <p className="line-clamp-4">{feedback.message}</p>
                    <span className="text-2xl text-blue-100 absolute -bottom-4 -right-2">"</span>
                  </blockquote>
                </div>
